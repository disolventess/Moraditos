// Completa los campos vacíos con tus datos reales. Los enlaces vacíos no se muestran.
export const site = {
  brand: "Moraditos",
  legalName: "", // Tu nombre comercial o razón social
  taxId: "", // RUC
  email: "support@moraditos.com", // Correo público de soporte
